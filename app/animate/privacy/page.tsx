...
const SECTIONS: LegalSectionContent[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We do not share, sell, or provide your mobile phone number or messaging consent data to third parties or affiliates for marketing or promotional purposes. We may share a number only with the SMS provider that sends messages on our behalf (Twilio) or when required by law.",
