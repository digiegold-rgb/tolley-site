...
export function ResearchPinGate() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, margin: "8px 0 2px" }}>Deep Research</h1>
        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.45)", marginBottom: 16 }}>
          Verified answers with cited sources
        </p>
        <input
          type="password"
          value={pin}
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 12,
            border: "none",
            background: loading ? "#1e3a5f" : "linear-gradient(90deg,#3b82f6,#06b6d4)",
            color: "white",
            fontWeight: 700,
            fontSize: 15,
