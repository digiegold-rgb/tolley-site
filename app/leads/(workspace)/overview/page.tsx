  ...
  const [hotLeads, statusCounts, overdueTasks, lastSync, listingCount, leadCount] =
    await Promise.all([
      (customerLeads((await requireLeadSubscriber()).id)).findMany({
        where: {
          score: { gte: 50 },
          status: { in: ["new", "contacted", "interested", "showing", "referred"] },
    ...
    <div className="relative space-y-5">
      ...
      <div className="grid gap-5 lg:grid-cols-12">
        ...
        <div className="space-y-5 lg:col-span-4">
          <TodayQueueWidget
            leads={todayLeads}
            title="Listings to research"
            subtitle="Scores are signals. Verify contact details and current circumstances before acting."
          />
