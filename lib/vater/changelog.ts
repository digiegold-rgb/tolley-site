...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '1.51.1',
    date: '2026-09-26',
    title: 'Inspect stock manifests before buying',
    items: ['Saved supplier manifests open as readable item tables directly from sourcing cards.'],
  },
  {
    version: '1.51.0',
    date: '2026-09-26',
  ...
  },
  {
    version: '1.50.6',
    date: '2026-09-25',
    title: 'Honest Bing check counts',
    items: ['The monthly Bing visibility check reports queries it had to skip for budget instead of counting them as recorded.'],
  },
  {
    version: '1.50.5',
    date: '2026-09-25',
    title: 'Bing check records every query',
    items: ['The monthly Bing visibility check finishes all its queries before reporting, so none are dropped.'],
  },
  {
    version: '1.50.4',
    date: '2026-09-25',
    title: 'Complete Bing checks',
    items: ['The monthly Bing visibility check runs its queries concurrently so every query is recorded.'],
  },
  {
    version: '1.50.3',
    date: '2026-09-25',
  ...
  },
  {
    version: '1.50.2',
    date: '2026-09-25',
    title: 'Current rental descriptions',
    items: ['The rental directory summary now reflects the currently offered equipment.'],
  },
  {
    version: '1.50.1',
    date: '2026-09-25',
    title: 'Reliable studio typography',
    items: ['Studio and portal headings use a bundled font so releases no longer depend on a remote font response.'],
  },
  {
    version: '1.50.0',
    date: '2026-09-25',
  ...
  },
  {
    version: '1.49.2',
    date: '2026-09-24',
    title: 'Cleanout quotes are open again',
    items: ['The Kansas City cleanouts page is back, including the free quote form.'],
  },
  {
    version: '1.49.1',
    date: '2026-09-21',
  ...
  },
  {
    version: '1.46.2',
    date: '2026-09-20',
    title: 'Whatnot market study in HQ Docs',
    items: ['HQ Docs now includes an illustrated Whatnot report with seller observations, sourcing examples, margin charts and a starter-budget test.'],
  },
  {
    version: '1.46.1',
    date: '2026-09-20',
  ...
  },
  {
    version: '1.45.0',
    date: '2026-09-20',
    title: 'Try the Tolley Post interactive demo',
    items: [
      'Try sample photos, edit product drafts and watch simulated delivery to five marketplaces without signing in.',
      'A guided tour walks through the workflow; sample data stays in your browser and nothing is posted or charged.',
    ],
  },
  {
    version: '1.44.0',
  ...
  },
  {
    version: '1.41.4',
    date: '2026-09-14',
    title: 'Retired unused sites',
    items: [
      'Removed Moupins, Junkin Jays, Last-Mile Delivery, Drive, Cleanouts, and E & T from the site directory and navigation.',
      'Retired pages now show that they are no longer available.',
    ],
  },
  {
    version: '1.41.3',
  ...
  },
  {
    ...
    items: [
      'The command palette now types the owner flag, so production typecheck can finish and Today can deploy.',
    ],
  },
  {
  ...
  },
  {
    version: '1.37.6',
    date: '2026-09-08',
    title: 'Release builds skip the Sentry webpack plugin on Standard',
    items: [
      'Production compile no longer wraps Next in the Sentry webpack plugin on the Standard 8 GB box. Error reporting at runtime stays. Maps can still be built on a bigger machine.',
    ],
  },
  {
    version: '1.37.5',
  ...
  },
  {
    version: '1.36',
    date: '2026-09-07',
    title: 'Generate library needs a second passcode',
    items: [
      'The /generate stills library stays locked after HQ / admin login until you enter the library passcode. Logging out clears that unlock.',
      'Anonymous visitors do not see the library, the job list, or still URLs. Motion / Cinema / generate forms still use the existing admin gate.',
    ],
  },
  {
    version: '1.35.2',
  ...
  },
  {
    version: '1.35.1',
    date: '2026-09-06',
    title: 'Cinema lane typechecks for production',
    items: [
      'Cinema can deploy. The estate proof beats and pasted image refs typecheck, so production build can finish.',
    ],
  },
  {
    version: '1.35',
