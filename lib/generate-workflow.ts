...
export const GENERATE_WORKFLOWS = [
  ...
  { id: "modal", title: "Create a character still", description: "Use reference photos to keep the same person while changing the scene or wardrobe.", engine: "Character stills · Qwen / FLUX.2", input: "Identity reference photos", output: "1–4 images", group: "Direct every detail" },
