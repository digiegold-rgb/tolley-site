...
const phases = [
  ...
  },
  {
    ...
    bg: "bg-amber-500/10",
    points: "2 of 3 suits closed",
    cash: "$2,453 spent",
    items: [
      { text: "⚖️ Central Bank — PAID IN FULL 7/7 (~$2,453 on $3,353), 8/19 trial CANCELED — now get pay-for-DELETE in writing", done: true },
      { text: "⚖️ Velocity/LendingClub (~$16K) — DISMISSED 8/19, no standing — pull the order, confirm with/without prejudice", done: true },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "PNC 8534 — JUDGMENT, $200/mo no-interest plan (~$4.6K left); PNC 9439 ($16,912) ON HOLD — settle $5K-8.5K later", done: false },
  ...
  },
  {
    ...
    cash: "$7,000-11,000",
    items: [
      { text: "Chase/JPMCB ($22,472) — suit DISMISSED, ON HOLD; settle $7K-11K pay-for-delete only if it resurfaces", done: false },
  ...
  },
  {
    ...
    cash: "$101K-121K equity",
    items: [
      { text: "Apply once FICO ≥ 680 AND documented income covers DTI (~12mo income seasoning)", done: false },
      { text: "Equity confirmed: $179K (value $390K − $210.7K) → $101K-121K borrowable", done: true },
