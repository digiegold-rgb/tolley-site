...
const phases = [
  ...
  },
  {
    id: "month4_5",
    label: "MONTH 4-5",
    sublabel: "Chase gone — clean up + truck",
    color: "#3b82f6",
    ...
    cash: "$0 — dismissed",
    items: [
      { text: "Chase/JPMCB ($22,472) — DISMISSED, not counted against you ✅ (dispute tradeline w/ order if it still shows a balance)", done: true },
