...
export default function DailyDesk({ data, owner }: { data: DailyDeskData; owner: boolean }) {
  ...
  return <div className="mx-auto max-w-5xl space-y-6">
    ...
    <div className="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
      ...
      <aside className="space-y-5"><section className="rounded-2xl border border-white/15 p-5"><h2 className="text-lg font-semibold">Get it out of your head</h2><p className="mt-1 text-sm text-white/55">Save the person and the promise together.</p><CaptureForm onSaved={onSaved} /></section>
