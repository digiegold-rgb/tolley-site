...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* Quick links */}
      <div className="mt-6 grid grid-cols-2 gap-3 md:grid-cols-4">
        <Link href="/leads/tools/analytics" className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-center transition hover:bg-white/[0.06]">
          <p className="text-2xl">📈</p>
          <p className="mt-1 text-xs text-white/50">Analytics</p>
        </Link>
        <Link href="/leads/tools/trends" className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-center transition hover:bg-white/[0.06]">
          <p className="text-2xl">🔥</p>
          <p className="mt-1 text-xs text-white/50">Trends</p>
        </Link>
        <Link href="/leads/tools/arbitrage" className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-center transition hover:bg-white/[0.06]">
          <p className="text-2xl">💰</p>
          <p className="mt-1 text-xs text-white/50">Arbitrage</p>
        </Link>
        <Link href="/leads/tools/affiliates" className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-center transition hover:bg-white/[0.06]">
          <p className="text-2xl">🔗</p>
