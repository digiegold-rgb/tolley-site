...
export function CoursePilotModules() {
  return (
    <section className="relative z-10 mx-auto max-w-4xl px-6 py-16">
      ...
      <p className="vater-section-subtitle mx-auto mb-10 text-center">
        {PILOT_COURSE.moduleCount} modules covering everything from first
        discovery flight to airline career.
      </p>

      <div className="flex flex-col gap-4">
        {PILOT_COURSE.modules.map((mod) => (
