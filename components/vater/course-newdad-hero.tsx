...
export function CourseNewdadHero() {
  return (
    <section className="relative flex flex-col items-center px-6 pb-16 pt-24 text-center">
      ...
      <span className="relative z-10 mb-4 text-5xl" role="img" aria-label="Baby">
        {NEWDAD_COURSE.icon}
      </span>
