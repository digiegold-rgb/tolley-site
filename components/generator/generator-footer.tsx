...
import { GEN_COMPANY, GEN_CONTACT_EMAIL, GEN_CONTACT_PHONE, GEN_FACEBOOK_URL } from "@/lib/generator";
      ...
      <div className="border-t border-slate-700/50 pt-6">
        <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          <nav className="flex items-center gap-3 text-sm text-slate-500">
            ...
            <Link href="/trailer/privacy" className="transition hover:text-yellow-400">
              Privacy
            </Link>
            <span className="text-slate-700">|</span>
            <a
              ...
              className="inline-flex items-center gap-1 transition hover:text-yellow-400"
            >
        ...
        <div className="mt-4 rounded-lg border border-amber-500/15 bg-amber-500/[0.04] px-4 py-2.5 text-center">
          <p className="text-xs font-bold tracking-wider text-amber-400/70 uppercase">
            ...
            <Link href="/trailer" className="text-amber-400 transition hover:text-amber-300">
              Check out our trailer rentals &rarr;
            </Link>
          </p>
        </div>
