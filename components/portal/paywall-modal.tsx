...
type PaywallModalProps = {
  ...
  onClose: () => void;
  onStartPlan: (plan: "basic" | "premium") => void;
};
      ...
      <div className="w-full max-w-lg rounded-3xl border border-white/20 bg-[linear-gradient(145deg,rgba(255,255,255,0.2),rgba(141,82,230,0.12)),rgba(10,8,18,0.72)] p-6 shadow-[0_20px_48px_rgba(3,2,10,0.66)] backdrop-blur-2xl">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-lg font-semibold text-white/92">$500 / month</p>
          ...
          >
            <p className="text-xs tracking-[0.12em] text-violet-100/75 uppercase">Premium</p>
            <p className="mt-1 text-lg font-semibold text-white/95">$800 / month</p>
            <p className="mt-1 text-sm text-white/76">Everything in Basic, plus advanced tooling.</p>
            <p className="mt-3 text-xs font-semibold tracking-[0.12em] text-violet-100 uppercase">
              {loadingPlan === "premium" ? "Starting..." : "Start Premium"}
            </p>
          </button>
        </div>
